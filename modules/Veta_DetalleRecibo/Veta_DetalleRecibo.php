   ...
   private function update_abono() {
    ...
    public function save( $check_notify = false ) {
        ...
        */
		...
		$actualizarabono = true;
                
                $collegeOld = $this->veta_college_id_c;
                
                $cOld = new Veta_College();
                $cOld->retrieve($collegeOld);

                $c = new Veta_Curso();
                $c->retrieve( $this->veta_curso_id_c );

		$cNew = new Veta_College();
                $cNew->retrieve($c->veta_college_id_c);
                
                if($cOld->moneda_c == $cNew->moneda_c){
                    $actualizarabono = false;
                }else{
                    $actualizarabono = true;
                }
