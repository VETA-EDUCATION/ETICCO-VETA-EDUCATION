...
class Veta_RequerimientoViewEdit extends ViewEdit
{
    ...
    public function display()
    {
        ...
        $campana->retrieve($this->bean->campaign_id_c);

        $this->ss->assign('REFERIDO', $this->bean->referido);
        $this->ss->assign('CAMPANA', $campana->name);
        $this->ss->assign('FUENTE', $this->bean->fuente);
