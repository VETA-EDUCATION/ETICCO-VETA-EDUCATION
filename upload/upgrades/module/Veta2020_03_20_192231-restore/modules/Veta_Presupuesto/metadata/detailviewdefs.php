    ...
    array (
      ...
      array (
        ...
        array (
          ...
          4 => 
          array (
            'customCode' => '<input value="Crear Cuenta de Cobro" type="button" class="button" onClick="document.location=\'index.php?module=Veta_Recibo&action=recibo&pid=\'+ document.getElementsByName(\'record\')[0].value" >',
          ),
          5 => 
          array (
