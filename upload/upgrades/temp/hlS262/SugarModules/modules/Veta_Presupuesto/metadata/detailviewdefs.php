    ...
    array (
      ...
      array (
        ...
        array (
          ...
          6 => array ('customCode' => '<input value="Enviar Presupuesto" type="button" class="button" onClick="document.location=\'index.php?module=Veta_Presupuesto&action=send&pid=\'+ document.getElementsByName(\'record\')[0].value" >', ),
        ),
      ),
      'maxColumns' => '2',
      'widths' => 
