...
$layout_defs["Veta_PagoColegios"]["subpanel_setup"]['activities'] = array (
  ...
  array (
    ...
    array (
      ...
      'get_subpanel_data' => 'veta_pagocolegios_activities_meetings',
    ),
    'tasks' => 
    array (
      'module' => 'Tasks',
      'subpanel_name' => 'ForActivities',
      'get_subpanel_data' => 'veta_pagocolegios_activities_tasks',
    ),
    'calls' => 
    array (
      'module' => 'Calls',
      'subpanel_name' => 'ForActivities',
      'get_subpanel_data' => 'veta_pagocolegios_activities_calls',
    ),
  ),
  'get_subpanel_data' => 'activities',
);
$layout_defs["Veta_PagoColegios"]["subpanel_setup"]['history'] = array (
  'order' => 20,
  'sort_order' => 'desc',
  ...
  array (
    ...
    array (
      'module' => 'Notes',
      'subpanel_name' => 'ForHistory',
      'get_subpanel_data' => 'veta_pagocolegios_activities_notes',
    ),
    'emails' => 
    array (
      'module' => 'Emails',
      'subpanel_name' => 'ForHistory',
      'get_subpanel_data' => 'veta_pagocolegios_activities_emails',
    ),
  ),
