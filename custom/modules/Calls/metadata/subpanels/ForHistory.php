...
$subpanel_layout = array(
	...
	'list_fields' => array(
		...
		'contact_id_c' => array (
			...
			'force_exists'=>true,
			'force_blank' => true,
			'force_default' => '(SELECT CONCAT(first_name, \' \' , last_name) FROM calls_cstm INNER JOIN contacts ON contacts.id = calls_cstm.contact_id_c WHERE calls_cstm.id_c=calls.id) AS',
		),
		'status'=>array(
