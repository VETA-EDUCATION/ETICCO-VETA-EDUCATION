...
$subpanel_layout = array(
	...
	'list_fields' => array(
		...
		'contact_id_c' => array (
			...
			'force_exists'=>true,
			'force_blank' => true,
			'force_default' => '(SELECT CONCAT(first_name, \' \' , last_name) FROM notes_cstm INNER JOIN contacts ON contacts.id = notes_cstm.contact_id_c WHERE notes_cstm.id_c=notes.id) AS',
		),
		'status'=>array(
