        ...
        'LNK_NEW_CONTACT' => array (
            array (
                array (
                    ...
                    'customCode' => '<input name="Contactsfirst_name" size="25" maxlength="25" type="text" value="{$fields.first_name.value}">',
                ),
                'last_name',
            ),
            array (
            ...
            /*array (
                'fecha_viaje_c',
                array (
                    'name' => 'fecha_viaje_2_c',
                    //'customCode' => '{html_options name="Contactssalutation" options=$fields.salutation.options selected=$fields.salutation.value}&nbsp;<input name="Contactsfirst_name" size="25" maxlength="25" type="text" value="{$fields.first_name.value}">',
                    'customCode' => '<input name="fecha_de_viaje_c" size="25" maxlength="25" type="text" value="{$fecha_viaje_2_c}">',
                    'label' => 'Fecha de Viaje 2',
                ),
            ),*/
