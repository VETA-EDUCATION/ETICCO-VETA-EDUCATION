...
$subpanel_layout = array(
	...
	'list_fields' => array(
		...
		'contact_id_c' => array (
			...
			'force_exists'=>true,
			'force_blank' => true,
			'force_default' => '(SELECT CONCAT(first_name, \' \' , last_name) FROM meetings_cstm INNER JOIN contacts ON contacts.id = meetings_cstm.contact_id_c WHERE meetings_cstm.id_c=meetings.id) AS',
		),
		'status'=>array(
