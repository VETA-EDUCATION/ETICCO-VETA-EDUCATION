...
class Veta_RequerimientoViewUpdate extends ViewEdit
{
    ...
    public function preDisplay()
    {
       // parent::preDisplay(); // TODO: Change the autogenerated stub
        ...
        $metadataFile = "modules/Veta_Requerimiento/metadata/updateviewdefs.php";
        $this->ev = new EditView();
        $this->ev->ss =& $this->ss;
        $this->ev->view = "update";

        $this->ev->setup($this->module, $this->bean, $metadataFile, 'include/EditView/EditView.tpl', true, 'updateviewdefs');
    }
