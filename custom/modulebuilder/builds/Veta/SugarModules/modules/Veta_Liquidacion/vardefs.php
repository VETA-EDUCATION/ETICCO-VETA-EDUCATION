...
$dictionary['Veta_Liquidacion'] = array(
  ...
  array (
    ...
    'len' => 100,
    'size' => '20',
    'options' => 'estado_pago_colegios_list',
    'studio' => 'visible',
    'dependency' => false,
  ),
  'name' => 
...
VardefManager::createVardef('Veta_Liquidacion', 'Veta_Liquidacion', array('basic','assignable','security_groups'));