...
class Veta_LooHooks
{
    ...
    private function asignar_info( $bean )
    {
        ...
        $query = "SELECT  
                ...
                INNER JOIN veta_requerimiento ON veta_requerimiento.id =  veta_requerimiento_veta_recibo_c.veta_requerimiento_veta_reciboveta_requerimiento_ida
                 WHERE veta_requerimiento.deleted = 0 AND veta_loo.deleted = 0 AND veta_loo.id = '" . $bean->id . "'";
    ...
    private function asignar_info_contact( $focus )
    {
        ...
        $query = "SELECT contacts.id AS ID, 
                ...
                INNER JOIN veta_loo ON veta_loo.id = veta_loo_veta_aplicacion_c.veta_loo_veta_aplicacionveta_loo_idb
                ...
                WHERE veta_loo.deleted = 0 AND veta_loo.id = '" . $focus->id . "'";
