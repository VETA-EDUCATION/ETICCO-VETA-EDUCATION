...
$searchFields[$module_name] = array(
    ...
    'range_soel_fecha_viaje' =>
        array (
            'query_type' => 'format',
            'operator' => 'subquery',
            'subquery' => 'SELECT veta_coe.id AS ID FROM veta_coe 
                           ...
                           INNER JOIN veta_liquidacion ON veta_liquidacion.id = veta_coe_veta_liquidacion_c.veta_coe_veta_liquidacionveta_liquidacion_ida AND veta_liquidacion.deleted = 0
                             ...
                             WHERE veta_coe.deleted = 0 AND veta_requerimiento.fecha_viaje >=  CONCAT(STR_TO_DATE(\'{0}\', \'' . $dateformat . '\') , \' 00:00:00\') and veta_requerimiento.fecha_viaje <= CONCAT(STR_TO_DATE(\'{0}\', \'' . $dateformat . '\') , \' 23:59:59\')',
            'db_field' => array ( 0 => 'id', ),
        ),
        ...
        array (
            ...
            'subquery' => ' SELECT veta_coe.id AS ID FROM veta_coe 
                            ...
                            INNER JOIN veta_liquidacion ON veta_liquidacion.id = veta_coe_veta_liquidacion_c.veta_coe_veta_liquidacionveta_liquidacion_ida AND veta_liquidacion.deleted = 0 
                             ...
                             INNER JOIN veta_requerimiento_veta_recibo_c ON veta_requerimiento_veta_recibo_c.veta_requerimiento_veta_reciboveta_recibo_idb = veta_recibo.id 
                             INNER JOIN veta_requerimiento ON veta_requerimiento.id = veta_requerimiento_veta_recibo_c.veta_requerimiento_veta_reciboveta_requerimiento_ida AND veta_requerimiento.deleted = 0 
                             WHERE veta_coe.deleted = 0 AND veta_requerimiento.fecha_viaje >=  CONCAT(STR_TO_DATE(\'{0}\', \'' . $dateformat . '\') , \' 00:00:00\')',
            'db_field' => array ( 0 => 'id', ),
        ),
        ...
        array (
            ...
            'subquery' => ' SELECT veta_coe.id AS ID FROM veta_coe 
                            ...
                            INNER JOIN veta_liquidacion ON veta_liquidacion.id = veta_coe_veta_liquidacion_c.veta_coe_veta_liquidacionveta_liquidacion_ida AND veta_liquidacion.deleted = 0 
                             ...
                             INNER JOIN veta_requerimiento_veta_recibo_c ON veta_requerimiento_veta_recibo_c.veta_requerimiento_veta_reciboveta_recibo_idb = veta_recibo.id 
                             INNER JOIN veta_requerimiento ON veta_requerimiento.id = veta_requerimiento_veta_recibo_c.veta_requerimiento_veta_reciboveta_requerimiento_ida AND veta_requerimiento.deleted = 0 
                             WHERE veta_coe.deleted = 0 AND veta_requerimiento.fecha_viaje <= CONCAT(STR_TO_DATE(\'{0}\', \'' . $dateformat . '\') , \' 23:59:59\')',
            'db_field' => array ( 0 => 'id', ),
        ),
