    ...
    array (
      ...
      array (
        ...
        array (
          ...
          1 => 
          array (
            'name' => 'veta_pagocolegios_activities_meetings_name',
          ),
        ),
        6 => 
        array (
          0 => 
          array (
            'name' => 'veta_aplicacion_activities_meetings_name',
          ),
          1 => 
          array (
            'name' => 'veta_loo_activities_meetings_name',
          ),
        ),
        7 => 
        array (
          0 => 
          array (
            'name' => 'veta_coe_activities_meetings_name',
          ),
          1 => 
          array (
            'name' => 'veta_visas_activities_meetings_name',
          ),
        ),
        8 => 
        array (
          0 => 
          array (
            'name' => 'veta_liquidacion_activities_meetings_name',
          ),
          1 => 
          array (
            'name' => 'veta_liquidacion_activities_meetings_name',
        ...
        array (
          0 => 
          array (
            'name' => 'veta_visa_activities_meetings_name',
          ),
          1 => 
          array (
            'name' => 'veta_visa_activities_meetings_name',
