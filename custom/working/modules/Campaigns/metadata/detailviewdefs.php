  ...
  array (
    ...
    array (
      ...
      array (
        0 => 
        array (
          'file' => 'custom/modules/Campaigns/javascript/copiarid.js',
        ),
      ),
      'form' => 
      array (
        ...
        array (
          ...
          7 => 
          array (
            'customCode' => '<input id="soelrecord" type="text" aria-hidden="true" style="position:absolute; left:-999em;" value=\'?cid={$fields.id.value}\'/> <input type="button" class="button" onclick="copiarid()" value="Copiar ID de Campaña"/>',
          ),
          8 => 'EDIT',
        ),
        'links' => 
